...
namespace Framework.AT.Runtime
{
	...
	internal class ATRegisterInternalHandler
	{
		...
		{
			Register(-8, typeof(Framework.Db.User),Framework.Db.Framework_Db_User.DoAction,1504128330/*Framework.Base.TypeObject*/);
			Register(-7, typeof(Framework.Db.UserManager),Framework.Db.Framework_Db_UserManager.DoAction,-1834191620/*Framework.Core.AModule*/);
			...
			Register(-4, typeof(Framework.ActorSystem.Runtime.Buff),Framework.ActorSystem.Runtime.Framework_ActorSystem_Runtime_Buff.DoAction,84673252/*Framework.ActorSystem.Runtime.AActorStateInfo*/);
			Register(-3, typeof(Framework.ActorSystem.Runtime.BuffSystem),Framework.ActorSystem.Runtime.Framework_ActorSystem_Runtime_BuffSystem.DoAction,-179068835/*Framework.ActorSystem.Runtime.TypeActor*/);
