...
namespace Framework.Guide
{
    ...
    public abstract class AGuideTag : MonoBehaviour
    {
        static HashSet<AGuideTag> ms_Tags = null;
        //------------------------------------------------------
        ...
        {
            if (ms_Tags == null)
                ms_Tags = new HashSet<AGuideTag>(8);
            ms_Tags.Add(this);
        }
        //------------------------------------------------------
        ...
        //------------------------------------------------------
        public static AGuideTag GetTag(AGuideGuid guide)
        {
            if (guide == null)
                return null;
