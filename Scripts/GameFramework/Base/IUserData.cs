...
namespace Framework.Base
{
    ...
    //------------------------------------------------------
    public interface IVarData : IUserData
    {
        void Destroy();
    }
    //------------------------------------------------------
    public struct BufferVar : IVarData
    {
        public byte[] buffers;
        public int bufferSize;

        public BufferVar(byte[] buffers, int bufferSize)
        {
    ...
    //------------------------------------------------------
    public struct TypeVar : IVarData
    {
    ...
    //------------------------------------------------------
    public struct CallbackVar : IVarData
    {
    ...
    //------------------------------------------------------
    public struct Callback1Var : IVarData
    {
    ...
    public struct ByteVar : IVarData
    {
        [FieldOffset(0)]
        public byte byteVal;
        [FieldOffset(0)]
    ...
    //------------------------------------------------------
    [StructLayout(LayoutKind.Explicit, Size = 1)]
    public struct UintVar : IVarData
    {
        [FieldOffset(0)]
        public uint uintVal;
    ...
    public struct Value1Var : IVarData
    {
        [FieldOffset(0)]
        public int intVal;
        [FieldOffset(0)]
    ...
    public struct Value2Var : IVarData
    {
        [FieldOffset(0)]
        public int intVal0;
        [FieldOffset(0)]
    ...
    public struct Value3Var : IVarData
    {
        [FieldOffset(0)]
        public int intVal0;
        [FieldOffset(0)]
    ...
    public struct Value4Var : IVarData
    {
        [FieldOffset(0)]
        public int intVal0;
        [FieldOffset(0)]
