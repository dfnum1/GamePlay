...
namespace Framework.SpriteSeq
{
    ...
    internal class SpriteSequenceEditor : Framework.ED.EditorWindowBase
    {
        ...
        static bool OnOpenAsset(int instanceID, int line)
        {
            ...
            if (obj != null && obj is ASpriteSequenceData)
            {
                SpriteSequenceEditor window = GetWindow<SpriteSequenceEditor>();
                window.Show();
                window.m_pData = obj as ASpriteSequenceData;
        ...
        private ASpriteSequenceData m_pData;
        //------------------------------------------------
        protected override void OnInnerEnable()
        {
            ...
            if (s_CustomIcon == null) s_CustomIcon = Framework.ED.EditorUtils.LoadEditorResource<Texture2D>("SpriteSequence/icon.png");
            this.titleContent = new GUIContent("精灵序列帧动画编辑器", s_CustomIcon);
            this.minSize = new Vector2(700, 550);
        }
        //------------------------------------------------
        ...
        protected override void OnInnerGUI()
        {
            if (m_pData == null)
            {
                ...
                if (GUILayout.Button("创建"))
                {
                    ...
                    m_pData = Framework.ED.EditorUtils.CreateUnityScriptObject<ASpriteSequenceData>();
        ...
        void DrawSubSequences()
        {
            ...
            {
                m_pData.subSequeneces.Add(new ASpriteSequenceData.SubSequence() { label = "", beginFrame = 0, endFrame = 0 });
            }
            GUILayout.EndHorizontal();
