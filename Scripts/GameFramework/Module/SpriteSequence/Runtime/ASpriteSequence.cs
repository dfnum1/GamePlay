...
{
    [RequireComponent(typeof(SpriteRenderer)),AddComponentMenu("")]
    public class ASpriteSequence : MonoBehaviour
    {
        [System.Serializable]
    ...
    //----------------------------------------------
#if UNITY_EDITOR
    [CustomEditor(typeof(ASpriteSequence))]
    public class ASpriteSequenceInspectorEditor : Editor
    {
        ...
        {
            ASpriteSequence seq = (ASpriteSequence)target;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(seq.subSequences!=null)
            {
                ...
                {
                    var newSubSeq = new ASpriteSequence.SubSequence() { label = "NewSubSeq", loop = true, fps = 12f, frames = new Sprite[0] };
                    var list = new System.Collections.Generic.List<ASpriteSequence.SubSequence>(seq.subSequences);
                    list.Add(newSubSeq);
        ...
        //----------------------------------------------
        ASpriteSequence.SubSequence DrawSpriteSequene(ASpriteSequence.SubSequence sequence)
        {
            ASpriteSequence seq = (ASpriteSequence)target;
