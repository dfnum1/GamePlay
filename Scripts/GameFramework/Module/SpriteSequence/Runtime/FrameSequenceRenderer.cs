...
namespace Framework.SpriteSeq
{
    ...
    internal class FrameSequenceRenderer
    {
        ...
        //--------------------------------------------------------
        internal void SetData(ASpriteSequenceData pData)
        {
            m_pData = pData;
            if (pData == null)
                return;
        ...
        //--------------------------------------------------------
        public void CameraRender(Camera camera, int drawLayer =0,float deltaTime =0)
        {
            if (m_nCount <= 0 ||
            ...
            if (camera!=null)
                ...
                UpdateJob(deltaTime, Matrix4x4.identity, false);
