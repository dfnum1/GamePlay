...
namespace Framework.SpriteSeq
{
    public class SpriteSequenceManager
    {
        ...
        //--------------------------------------------------------
        public void AddSequence(int guid, ASpriteSequenceData sequenceData, string label, int sortingOrder = 0)
        {
        ...
        public void Render(Camera camera = null, int drawLayer =0, float deltaTime = 0)
        {
            ...
            {
                renderer.Value.CameraRender(camera, drawLayer, deltaTime);
            }
        }
        //--------------------------------------------------------
        public void Clear()
