...
namespace Framework.ActorSystem.Runtime
{
    ...
    public class IntersetionUtil
    {
        ...
        //------------------------------------------------------
        public static bool CU_OBBOBBIntersection(IntersetionParam frameParams, FVector3 vCenter1, FVector3 vHalf1, FMatrix4x4 mWorld1, FVector3 vCenter2, FVector3 vHalf2, FMatrix4x4 mWorld2)
        {
        ...
        //------------------------------------------------------
        public static bool CU_LineOBBIntersection(IntersetionParam frameParams, FVector3 lineStart, FVector3 lineEnd, FVector3 vCenter, FVector3 vHalf, FMatrix4x4 mWorld)
        {
#if USE_FIXEDMATH
        ...
        //------------------------------------------------------
        public static bool CU_LineSphereIntersection(IntersetionParam frameParams, FVector3 lineStart, FVector3 lineEnd, FVector3 vCenter, FFloat fRadius)
        {
        ...
        //------------------------------------------------------
        public static bool CU_LineOBBIntersection(IntersetionParam frameParams, out FFloat result, FVector3 lineStart, FVector3 lineEnd, FVector3 vCenter, FVector3 vHalf, FMatrix4x4 mWorld)
        {
            result = 0;
#if USE_FIXEDMATH
        ...
        //------------------------------------------------------
        public static void CU_GetBoundPoints(IntersetionParam frameParams, WorldBoundBox box, out FVector3[] vDirArray, out FVector3[] vVertexArray)
        {
