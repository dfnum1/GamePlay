...
#if UNITY_EDITOR
    [CustomEditor(typeof(AActorComponent))]
    public class AActorComponentEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            {
                ActionEditorWindow.OpenTarget(target as AActorComponent);
            }
        ...
        private static bool ValidateOpenActorComponent()
        {
            if (Selection.activeGameObject == null)
                return false;
            return Selection.activeGameObject.GetComponent<AActorComponent>() != null;
        }
        //-----------------------------------------------------
        ...
        private static void OpenActorComponent()
        {
            ...
            if (obj != null)
            {
                ActionEditorWindow.OpenTarget(Selection.activeGameObject.GetComponent<AActorComponent>());
            }
        }
    }
#endif
