...
namespace Framework.ActorSystem.Editor
{
       ...
       //     m_pSkillEditor = null;
        ...
        protected override void OnStart()
        {
            ...
            if (m_pActorComp)
            {
                ...
                pActorInstance = m_pActorManager.CreateActor(null, null, -9999);
   ...
   //         m_pActor.GetSkillSystem().AddLockTarget(m_pTarget);
       ...
       //     if (m_pTarget != null) m_pTarget.Update(m_pTimer.deltaTime);
        ...
        //--------------------------------------------------------
        public void OnCutsceneLoadAsset(string name, System.Action<UnityEngine.Object> onLoaded, bool bAsync = true)
        {
        ...
        //--------------------------------------------------------
        public void OnCutsceneSpawnInstance(string name, System.Action<UnityEngine.GameObject> onLoaded, bool bAsync = true)
        {
