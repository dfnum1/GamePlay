...
{
    [Inspector(typeof(ProjectileData), "OnDrawProjectData")]
    public class ProjectileDataDrawer
    {
        ...
        static void DrawBounds(DrawData drawData, ProjectileData projectile, Vector2 size)
        {
            ...
            if (projectile.bound_count > 0)
            {
                ...
                InspectorDrawUtil.DrawPropertyByFieldName(projectile, "bound_sound_launch", null, "弹射发射音效");
        ...
        {
            return ActorSystem.Editor.EditorUtil.DrawActionAndTag(stateAndTag, name, isHorizontal, op);
        }
    }
}
#endif