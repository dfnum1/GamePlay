...
namespace Framework.AT.Editor
{
    ...
    {
        public static readonly Color kErrorColor = new Color(0.957f, 0.737f, 0.008f, 1f);
        public static readonly IconData[] k_ClipErrorIcons = { new IconData { icon = iconWarn, tint = kErrorColor } };
