    ...
    public class ACutsceneObject : ScriptableObject/*, ISerializationCallbackReceiver*/
    {
        ...
        */
        ...
        private static bool ValidatePlayCutscene()
        {
            ...
            var obj = Selection.activeObject as ACutsceneObject;
            return obj != null;
        }
        //-----------------------------------------------------
        ...
        private static void PlayCutscene()
        {
            ...
            if (obj != null)
            {
                ...
                if (runtimeMgr != null)
                {
                    var grpahData = ((ACutsceneObject)obj).GetCutsceneGraph();
...
#if UNITY_EDITOR
    [CustomEditor(typeof(ACutsceneObject))]
    public class ACutsceneObjectEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ACutsceneObject cutsceneObject = (ACutsceneObject)target;
